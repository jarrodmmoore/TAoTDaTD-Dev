...
$execute positioned ^ ^ ^$(force) if loaded ~ ~ ~ run summon marker ~ ~ ~ {UUID:[I;5,6,7,1]}
execute store result score #coord_x2 value run data get entity 00000005-0000-0006-0000-000700000001 Pos[0] 100000
execute store result score #coord_y2 value run data get entity 00000005-0000-0006-0000-000700000001 Pos[1] 100000
execute store result score #coord_z2 value run data get entity 00000005-0000-0006-0000-000700000001 Pos[2] 100000
kill 00000005-0000-0006-0000-000700000001
...
#x
execute store result score #test3 value run data get entity @s Motion[1] 2500
scoreboard players operation #test3 value += #coord_y2 value
execute store result entity @s Motion[1] double 0.0004 run scoreboard players get #test3 value
#z
