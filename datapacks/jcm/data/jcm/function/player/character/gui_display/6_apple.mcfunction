...
execute if score #test value matches 1 if score #collectedApple1 value matches 1.. if score #collectedApple2 value matches 1.. run clear @s *[custom_data~{questInfo:6}]
...
execute if score #gameProgress value matches 2.. if score #count1 value matches 2.. run item replace entity @s inventory.15 with red_dye[custom_data={questInfo:6},item_model="apple",custom_name=[{translate:"jcm.quest.apples",bold:true,italic:false}],lore=[{translate:"jcm.quest.2_2_collected",italic:true,color:yellow}]] 2