...
execute if score #test value matches 1 if score #collectedBottle1 value matches 1.. if score #collectedBottle2 value matches 1.. run clear @s *[custom_data~{questInfo:5}]
...
execute if score #gameProgress value matches 2.. if score #count1 value matches 2.. run item replace entity @s inventory.14 with red_dye[custom_data={questInfo:5},item_model="jcm/gui/bottle_2",custom_name=[{translate:"jcm.quest.water_bottles",bold:true,italic:false}],lore=[{translate:"jcm.quest.2_2_collected",italic:true,color:yellow}]] 2